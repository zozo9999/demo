...
//<profile> <id> <build> <pluginmanagement> <plugin> maven configuration and suitexmlfile 

//cucumber
// "^blah blah <username>. Black ^" ^ is required for input parameters
// if no input parameter is required, no need ^
@Listeners(WBListen.class)
public class Main2 extends Main2base {
